...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About RealPointCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>RealPointCoin</b> version", 0));
...
"Copyright \302\251 2016 The RealPointCoin developers", 0));

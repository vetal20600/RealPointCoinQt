...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 RPC"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 RPC"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 RPC"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 RPC"));

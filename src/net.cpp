...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("realpointcoin-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("realpointcoin-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("realpointcoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "RealPointCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("realpointcoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("realpointcoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("realpointcoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("realpointcoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. RealPointCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("realpointcoin-start");
